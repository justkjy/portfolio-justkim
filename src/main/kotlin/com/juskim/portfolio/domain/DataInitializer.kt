package com.juskim.portfolio.domain

import Introduction
import com.juskim.portfolio.domain.constant.SkillType
import com.juskim.portfolio.domain.entity.*
import com.juskim.portfolio.domain.repository.*
...
class DataInitializer (
    ...
    @PostConstruct
    fun initializeData() {
        // 실제 할때는 아래 프린트문 지우자 프린트는 프로그램을 느리게 한다.
        ...
        val introductions = mutableListOf<Introduction>(
            Introduction(content = "주도적 문제", isActive = true),
            Introduction(content = "기술을 위한 기술", isActive = true),
            Introduction(content = "기존 소스를 리팩토링", isActive = true)
        )
        introductionRepository.saveAll(introductions)

        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://github.com/justkim", isActive = true),
