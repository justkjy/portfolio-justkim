package com.justkim.portfolio.admin.advice

import com.justkim.portfolio.admin.exception.AdminException
...
class AdminApiControllerAdvice {
    ...
    fun handleException(e: Exception): ResponseEntity<String> {
        ...
        return ResponseEntity.internalServerError().body("시스템 오류가 발생습니다.")
    }
}